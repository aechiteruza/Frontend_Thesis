...
import { ModalHeader, ModalBody, ModalFooter, Modal, Button, Card, CardBody, Col, Container, InputGroup, InputGroupAddon, InputGroupText, Row } from 'reactstrap';
...
class Register extends Component {
  ...
  */
  ...
  checkduplicateusername() {
    ...
    let url = 'http://192.168.56.103:3000/auth/checkuser';
    fetch(url, {
      method: "POST",
      ...
      .then(responseJson => {
        ...
        if (responseJson.success) {
          ...
          if (pwd === rpwd) {
            let url = 'http://192.168.56.103:3000/users/register';
              ...
              <Card className="mx-4">
                <CardBody className="p-4">
                  ...
                  <Modal isOpen={this.state.successregister} toggle={this.SuccessRegister} className={this.props.className}>
                    ...
                    <ModalFooter>
                      <Link to='/Login'><Button color="secondary" onClick={this.SuccessRegister}>Close</Button></Link>
                    </ModalFooter>
                  </Modal>
                  {/*
