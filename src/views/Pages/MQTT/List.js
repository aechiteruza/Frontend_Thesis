...
class List extends Component{
  constructor() {
    ...
    render() {
        ...
        if(this.props.details.namemqtt === undefined) this.item = "";
      else {
          this.item = this.props.details.namemqtt.map((item, key) =>
          
          <tr>
           
           <td><button disabled="true" aria-pressed="true" class="btn btn-dark btn-block active">{item.namemqtt}</button></td>
           <td>
           <ListStatus namecontainer={item.namemqtt} />
           </td>
           <td>
           <ListPort namecontainer={item.namemqtt}/>
           </td>
           <td>
           <Listname name={item.namemqtt} /></td>
           </tr>
...
class ListStatus extends Component{
  ...
  getcontainer() {
    ...
    let url = 'http://192.168.56.103:3000/namemqttt/getstatuscontainer';
    fetch(url, {
      method: "POST",
...
class ListPort extends Component{
  ...
  getcontainer() {
    ...
    let url = 'http://192.168.56.103:3000/namemqttt/getportcontainer';
    fetch(url, {
      method: "POST",
      body: JSON.stringify(dataToSend),
      headers: {
...
class Listname extends Component{
  ...
  runcontainer() {
    ...
    //e.preventDefault();  
    //console.log("RUN CONT")
    let dataToSend = {
      userData: {
        username: localStorage.getItem("USERS_USERNAME"), 
        namemqtt: this.props.name
      },
    };
    let url = 'http://192.168.56.103:3000/namemqttt/runcontainer';
    fetch(url, {
      method: "POST",
      body: JSON.stringify(dataToSend),
      headers: {
  ...
  deletecontainner() {
    ...
    let url = 'http://192.168.56.103:3000/namemqttt/deletecontainner';
    fetch(url, {
      method: "POST",
      body: JSON.stringify(dataToSend),
      headers: {
  ...
  stopcontainner() {
    ...
    let url = 'http://192.168.56.103:3000/namemqttt/stopcontainner';
    fetch(url, {
      method: "POST",
      body: JSON.stringify(dataToSend),
      headers: {
